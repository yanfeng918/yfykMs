...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		byte[] bs = RedisUtils.get(Setting.CACHE_KEY);
		...
		if (object != null) {
			...
			try {
				...
				List<Element> elements = document.selectNodes("/yjb/setting");
			...
			//set cache
			RedisUtils.set(Setting.CACHE_KEY, SerializeUtil.serialize(setting));
		}
	 ...
	 * 设置系统设置
	 * 
	 * @param setting 系统设置(暂时不使用，没有进行修改)
	 */
