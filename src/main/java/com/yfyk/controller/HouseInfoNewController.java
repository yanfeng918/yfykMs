...
public class HouseInfoNewController {
    ...
    @Autowired
    private HouseInfoNewService houseInfoNewService;
                ...
                for (int index = 1; index <=sheet.getLastRowNum(); index++) {
                    ...
                    try {
                        if (row != null) {
                            ...
                            //判断是否重复
                            if (houseInfoNewService.isHouseExist(houseInfo.getMobile(),houseInfo.getBan(),houseInfo.getRoomnumber())) {
...
//							houseInfo.setStatus(HouseInfo_STATUS.APPLY);
                            ...
                            houseInfoNewService.add(houseInfo);
