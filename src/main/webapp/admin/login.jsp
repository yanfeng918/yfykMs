<%@page import="com.yjbadmin.common.service.RSAService"%>
<%@page import="com.yjbadmin.bean.Setting.AccountLockType"%>
<%@page import="com.yjbadmin.bean.Setting.CaptchaType"%>
<%@page import="com.yjbadmin.utils.SpringUtils"%>
<%@page import="com.yjbadmin.bean.Setting"%>
<%@page import="com.yjbadmin.utils.SettingUtils"%>
				...
				<table>
					...
					<%if (ArrayUtils.contains(setting.getCaptchaTypes(), CaptchaType.adminLogin)) {%>
						<tr>
							...
							<td>
								<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off" /><img id="captchaImage" class="captchaImage" src="<%=base%>/common/captcha?captchaId=<%=captchaId%>" title="<%=SpringUtils.getMessage("admin.captcha.imageTitle")%>" />
							</td>
						</tr>
					<%}%>
					<tr>
