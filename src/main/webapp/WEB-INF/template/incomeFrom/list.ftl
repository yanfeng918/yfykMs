...
<body>
	<div class="path">
		<a href="${base}/admin/index/">${message("admin.path.index")}</a> &raquo; 系统收入列表 <span>(${message("admin.page.total", pager.totalCount)})</span>
	</div>
	<form id="listForm" action="list" method="get">
				...
				<div class="menuWrap">
					...
					<div class="popupMenu">
						<ul id="filterOption">
							...
							<li>
								<a href="javascript:;"[#if status== 'refund'] class="current"[/#if] val="refund">系统退款</a>
							</li>
							<li>
								<a href="javascript:;"[#if status== 'dealIncome'] class="current"[/#if] val="dealIncome">交易收入</a>
							</li>
						</ul>
					</div>
				</div>
        ...
        <div class="demos">
                <span>起止时间▼<input name="beginDate" type="text" id="beginDate" size="10" maxlength="10" value="${beginDate}"
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="createDate">收入时间</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="">收入金额</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="">收入源</a>
				</th>
			...
			[#list pager.list as income]
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${income.id}" />
					</td>
					<td>
						[#if (income.createDate)??]
							${(income.createDate)?string("yyyy-MM-dd HH:mm:ss")}
						[/#if]
					</td>
					...
					<td>
						${income.incomeFrom.username}
					</td>

					<td>
                        [#if income.incomeType=="refund"]
                            <span class="red">系统扣款</span>
                        [#elseif income.incomeType=="dealIncome"]
                            <span class="red">交易收入</span>
                        [/#if]
					</td>
				</tr>
			[/#list]
    ...
    <h3 class="red">总收入：${count?string("0.#")}</h3>
    <br/>
</body>
</html>