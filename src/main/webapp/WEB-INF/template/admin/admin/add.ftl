...
//			},
                ...
                <body>
                <div class="path">
                    <a href="${base}/admin/index">${message("admin.path.index")}</a> &raquo; 编辑管理员
                </div>
                <form id="inputForm" action="save" method="post">
                    ...
                    <table class="input tabContent">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="username" class="text" maxlength="20"/> <span
                                    class="red">${reason}</span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="input" id="name" name="name" class="text" maxlength="20"/>
                            </td>
                        </tr>
                        <tr>
                            <th>
			...
			<tr class="roles">
				...
				<td>
                    审核员：
                    <input type="radio" checked="checked" name="roleIds" value="2"/><br/>
                    管理员：
                    <input type="radio"  name="roleIds" value="1"/>

				</td>
			</tr>
                        <tr class="roles">
                            <th>
                                <span class="requiredField">*</span>可审核城市:
                            </th>
                            <td>
                            [#list cityList as city]
                                ${city.name}
                                <input type="radio" checked="checked" name="cityIds" value="${city.id}"/><br/>
                            [/#list]
                            </td>
                        </tr>
			<tr>
