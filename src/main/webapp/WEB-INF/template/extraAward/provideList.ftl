...
<script type="text/javascript">
	...
	var url = "${base}/auth/extraAward/provide";
	$.ajax({
	type: "GET",
	async: true,
	url: url,
...
<body>
	<div class="path">
		<a href="${base}/admin/index/">${message("admin.path.index")}</a> &raquo; 额外奖励确认 <span>(${message("admin.page.total", pager.totalCount)})</span>
	</div>
	<form id="listForm" action="provideList" method="get">
		...
		<div class="bar">
            ...
            <div style=" margin-left: 90%;">
                <input type="button" id="ensure1" name="ensure1"  style="height:28px" value="确认" onclick="ensure()">
            </div>
		</div>
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="name">会员名</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="mobile">本月房源数</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="createDate">一级房源数</a>
				</th>
                <th>
                    <a href="javascript:;" class="sort" name="createDate">二级房源数</a>
                </th>
                <th>
                    <a href="javascript:;" class="sort" name="createDate">上月房源数</a>
                </th>
                <th>
                    <a href="javascript:;" class="sort" name="createDate">额外奖励</a>
                </th>
			</tr>
			[#list data as extraAward]
				<tr>
					<td width="2%">
						${extraAward_index+1}
					</td>
					...
					<td>
						${extraAward.thisMonNum}
					</td>
					<td>
						${extraAward.firLevelNum}
					</td>
                    <td>
						${extraAward.secLevelNum}
                    </td>
                    <td>
						${extraAward.lastMonNum}
                    </td>
                    <td>
