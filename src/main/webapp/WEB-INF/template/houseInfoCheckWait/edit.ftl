...
<form id="inputForm" action="update" method="post">
    ...
    <table class="input tabContent">
        ...
        <tr>
            ...
            <td colspan="5">
                <input type="text" name="description" class="text" value="${houseInfo.description}"
                       style="width: 600px;height:50px"/>
                <input type="hidden" name="infoPrice" class="text" value="${houseInfo.infoPrice}"/>
            </td>
        ...
        <tr bgcolor="#fffbe5">
            ...
            <td>
                <input type="text" name="mobile" class="text" value="${houseInfo.mobile}" maxlength="200"
                       style="font-weight:900;height:30px;color:red"/>
            </td>
            <th></th>
            <td><input type="image" src="../resources/admin/images/success.png" value="通过" onclick="pass()"/>
        </tr>
        <tr>
            <th>
                审核备注:
            ...
            [#--<input type="text" id="content" name="checkContent" class="text" value="${houseInfo.checkContent}" maxlength="200"/>--]
                <select name="checkContent" style="font-weight:900;height:30px;width:300px">
                    ...
                    <option value="其它号码已上架"
                            [#if (houseInfo.checkContent)?? &&(houseInfo.checkContent)=="其它号码已上架"]selected="selected"[/#if]>
                        其它号码已上架
                    </option>
                    <option value="无此房源"
                    ...
                    [#--</option>--]
                    <option value="多次未接通"
                            [#if (houseInfo.checkContent)?? &&(houseInfo.checkContent)=="多次未接通"]selected="selected"[/#if]>
                        多次未接通
                    </option>
                    <option value="非上架房源"
                            [#if (houseInfo.checkContent)?? &&(houseInfo.checkContent)=="非上架房源"]selected="selected"[/#if]>
                        非上架房源（办公楼，写字楼，商铺，宅基地，拍卖，一手，）
                    </option>
                </select>
            </td>
        </tr>
        <tr>
            ...
            [#if houseInfo.status=="CHECKING"]
                <input type="image" src="../resources/admin/images/disCon1.png" id="disConnect"
                       onclick="disConnect1()"/>
            [#elseif houseInfo.status=="CHECKING_DISCON1"]
                <input type="image" src="../resources/admin/images/disCon2.png" id="disConnect"
                       onclick="disConnect1()"/>
            [#elseif houseInfo.status=="CHECKING_DISCON2"||houseInfo.status=="FAIL_DISCON3"]
                <input type="image" src="../resources/admin/images/fail-disCon3.png" id="disConnect"
                       onclick="disConnect1()"/>
            [/#if]

                <input type="image" src="../resources/admin/images/unavailable.png" value="失败-无效房源"
                       onclick="unAvailable()"/>
                [#--<input type="image" src="../resources/admin/images/fail-soldout.png" value="失败-已出售"--]
                       [#--onclick="soldOut()"/>--]
