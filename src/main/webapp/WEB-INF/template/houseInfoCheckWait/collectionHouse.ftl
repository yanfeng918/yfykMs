...
<body">
	...
	<div class="path">
		<a href="${base}/admin/index">${message("admin.path.index")}</a> &raquo;征集房源审核
	</div>
	<form id="inputForm" action="updateCollection" method="post">
        ...
        <table class="input tabContent">
            <tr>
                <th class="red">征集信息:</th><td></td><th></th><td></td></tr>
            <tr>
                <th>
                    小区:
                </th>
               <td>
               ${collectionInfo.community}
               </td>
                <th>
                    描述 :
                </th>
            ...
            <tr>
                ...
                <td>
                ${collectionInfo.roomNumber}
                </td>
                <th>
                    户型 :
                </th>
                <td>
                ${collectionInfo.houseShape}
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                ${collectionInfo.areaSize}
                </td>
                <th>
                    售价:
                </th>
                <td>
                ${collectionInfo.salePrice}
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                <th class="red">房源信息:</th><td></td><th></th> <td></td>
            </tr>
			<tr>
				<th>
					房源业主姓名:
		...
		<tr>
            ...
            <tr>
                ...
                <td colspan="6">
                [#if houseInfo.status=="APPLY"||houseInfo.status=="CHECKING"]
    ...
    <script type="text/javascript">
    	...
    	function disConnect1(){
    		if(document.getElementById("currentStatus").value=="APPLY"|| document.getElementById("currentStatus").value == "CHECKING"){
